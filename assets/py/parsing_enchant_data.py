...
# slots = ['boots','bracers','gloves', 'weapon', 'chest', 'shield', 'cloak']
slots = ['boots']
...
def get_data(site):
	...
	if site=='wowhead':
		BASE_URL = "https://classic.wowhead.com/enchanting-spells?filter=20;1;0"
		driver.get(BASE_URL)
...
with open('/Users/kjt/Desktop/enchant_data.txt', 'w') as f:
