...
ALL_ERRORS = get_item_list(os.path.abspath('data/ERRORS.js'))

NPCS = get_item_list(os.path.abspath('data/npcs.js'))
# QUESTS = get_item_list(os.path.abspath('../js/quests.js'))
# ITEMSETS = get_item_list(os.path.abspath('../js/itemsets.js'))
ZONES = get_item_list(os.path.abspath('data/zones.js'))
FACTIONS = get_item_list(os.path.abspath('data/factions.js'))
OBJECTS = get_item_list(os.path.abspath('data/objects.js'))
SPELLS = get_item_list(os.path.abspath('data/spells.js'))
RUNTIME_STATS = get_item_list(os.path.abspath('data/runtime_stats.js'))
