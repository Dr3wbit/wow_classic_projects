# Generated by Django 2.2.2 on 2019-06-21 19:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('gathered', 'gathered'), ('drop', 'drop'), ('quest', 'quest'), ('crafted', 'crafted'), ('vendor', 'vendor')], default='drop', max_length=15)),
            ],
            options={
                'ordering': ['name'],
            },
