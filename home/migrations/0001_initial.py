# Generated by Django 2.2.4 on 2019-08-23 11:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(999)])),
            ],
        ),
        migrations.CreateModel(
            name='Crafted',
            fields=[
                ...
                ('skillup', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('profession_level', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(300)])),
            ],
        ),
        migrations.CreateModel(
            name='Damage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_slot', models.PositiveSmallIntegerField(choices=[(1, 'Head'), (2, 'Neck'), (3, 'Shoulder'), (4, 'Shirt'), (5, 'Chest'), (6, 'Waist'), (7, 'Legs'), (8, 'Feet'), (9, 'Wrist'), (10, 'Hands'), (11, 'Finger'), (12, 'Finger2'), (13, 'Trinket'), (14, 'Trinket2'), (15, 'Back'), (16, 'Main Hand'), (17, 'Off Hand'), (18, 'Ranged'), (19, 'Tabard'), (20, 'Bag'), (21, 'Bag2'), (22, 'Bag3'), (23, 'Bag4'), (24, 'Two-hand'), (25, 'One-hand'), (26, 'Thrown'), (27, 'Relic'), (28, 'Held In Off-Hand'), (29, 'Projectile')], default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(20)])),
                ...
                ('stats', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('resists', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('requirements', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('durability', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(400)])),
                ('description', models.CharField(blank=True, max_length=250)),
                ('bagslots', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(30)])),
                ('val', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, help_text='Monetary Value', null=True)),
                ('disenchant', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('consume', models.BooleanField(default=False)),
                ('damage', models.ManyToManyField(to='home.Damage')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            name='School',
            fields=[
                ('ix', models.PositiveIntegerField(primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MaxValueValidator(7)])),
                ('name', models.CharField(default='', max_length=30)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('pvp', 'PvP'), ('wpvp', 'wPvP'), ('bgs', 'BGs'), ('pve', 'PvE'), ('meme', 'MeMe'), ('mc', 'MC'), ('bwl', 'BWL'), ('zg', 'ZG'), ('aq20', 'AQ20'), ('aq40', 'AQ40'), ('naxx', 'Naxx'), ('5man', '5-man'), ('melee', 'Melee'), ('caster', 'Caster'), ('healer', 'Healer'), ('tank', 'Tank'), ('dps', 'DPS'), ('horde', 'Horde'), ('alliance', 'Alliance')], max_length=15, unique=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddField(
            model_name='damage',
            name='i',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='home.Item'),
        ),
        migrations.AddField(
            model_name='damage',
            name='school',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locked', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.Talent')),
                ('tree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.TalentTree')),
                ('wow_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.WoWClass')),
            ],
            options={
