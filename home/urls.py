...
urlpatterns = [
    ...
    re_path(class_re, views.TalentCalcTemplate.as_view(), name='talents'),
    re_path(class_re+id_re, views.TalentCalcTemplate.as_view(), name='talent_helper'),
    ...
    re_path(profession_re, views.ConsumeToolTemplate.as_view(), name='recipes'),
