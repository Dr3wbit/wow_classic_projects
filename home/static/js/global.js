...
function updateListInfo(data = {}) {
	...
	if (data.list_info) {
		...
		let row = create_element("div", "row"),
			col = create_element("div", "offset-1 col-10"),
			descriptionText = "Want to share this list with others? Save it using the form below and use the link in the address bar";
